<template>
    <div style="max-height:80vh;">
        ...
        >
            <wj-flex-grid-filter :filterColumns="['userName','userId','phoneNo','enterDate','masterYn','rankId','departmentId',]" />
            ...
            <wj-flex-grid-column binding="enterDate" header="enterDate" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="masterYn" header="masterYn" width="2*" :isReadOnly="true" align="center" />
