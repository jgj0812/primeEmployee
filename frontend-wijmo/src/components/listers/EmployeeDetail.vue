<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Date label="EnterDate" v-model="item.enterDate" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Boolean label="MasterYn" v-model="item.masterYn" :editMode="editMode" @change="change" />
            </div>
